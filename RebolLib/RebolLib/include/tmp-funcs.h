...
extern void Init_UType_Proto(); // b-init.c
extern void Set_Root_Series(REBVAL *value, REBSER *ser, REBYTE *label); // b-init.c
extern REBINT Codec_Text(REBCDI *codi); // b-init.c
extern REBINT Codec_Markup(REBCDI *codi); // b-init.c
extern void Register_Codec(REBYTE *name, codo dispatcher); // b-init.c
extern void Init_Task(void); // b-init.c
extern void Init_Year(void); // b-init.c
extern void Init_Core(REBARGS *rargs); // b-init.c
extern char *Prompt_User(); // b-main.c
extern int main(int argc, char **argv); // b-main.c
...
extern REBINT Eval_Depth(); // c-do.c
...
extern void Trap_Stack(); // c-error.c
extern REBCNT Stack_Depth(); // c-error.c
...
extern void Check_Bind_Table(); // c-frame.c
...
extern void Free_Port_State(REBSER *port); // c-port.c
extern REBFLG Pending_Port(REBVAL *port); // c-port.c
extern REBINT Awake_System(REBSER *ports); // c-port.c
extern REBINT Wait_Ports(REBSER *ports, REBCNT timeout); // c-port.c
...
extern REBCNT Make_Word(REBYTE *str, REBCNT len); // c-word.c
...
extern void Dump_Series(REBSER *series, REBYTE *memo); // d-dump.c
...
extern void Out_Str(REBYTE *bp, REBINT lines); // d-print.c
extern void Enable_Backtrace(REBFLG on); // d-print.c
extern void Display_Backtrace(REBCNT lines); // d-print.c
extern void Debug_String(REBYTE *bp, REBINT len, REBOOL uni, REBINT lines); // d-print.c
extern void Debug_Line(void); // d-print.c
extern void Debug_Str(REBYTE *str); // d-print.c
...
extern void Debug_Fmt_(REBYTE *fmt, ...); // d-print.c
...
extern REBYTE *Decode_Binary(REBVAL *value, REBYTE *src, REBCNT len, REBINT base, REBYTE delim); // f-enbase.c
extern REBSER *Encode_Base2(REBVAL *value, REBSER *series, REBFLG brk); // f-enbase.c
extern REBSER *Encode_Base16(REBVAL *value, REBSER *series, REBFLG brk); // f-enbase.c
extern REBSER *Encode_Base64(REBVAL *value, REBSER *series, REBFLG brk); // f-enbase.c
...
extern REBYTE *Grab_Int(REBYTE *cp, REBINT *val); // f-math.c
extern REBYTE *Grab_Int_Scale(REBYTE *cp, REBINT *val, REBCNT scale); // f-math.c
...
extern REBINT Emit_Decimal(REBYTE *cp, REBDEC d, REBFLG percent, REBYTE point, REBINT digits); // f-math.c
...
extern void Long_To_Bytes(REBYTE *out, REBCNT in); // f-stubs.c
extern REBCNT Bytes_To_Long(REBYTE *in); // f-stubs.c
...
extern REBINT Partial1(REBVAL *sval, REBVAL *lval); // f-stubs.c
...
extern REBVAL *Make_OS_Error(); // f-stubs.c
...
extern REBYTE *Scan_Item(REBYTE *src, REBYTE *end, REBUNI term, REBYTE *invalid); // l-scan.c
extern REBSER *Scan_Source(REBYTE *src, REBCNT len); // l-scan.c
extern REBINT Scan_Header(REBYTE *src, REBCNT len); // l-scan.c
extern void Init_Scanner(void); // l-scan.c
extern REBCNT Scan_Word(REBYTE *cp, REBCNT len); // l-scan.c
extern REBCNT Scan_Issue(REBYTE *cp, REBCNT len); // l-scan.c
extern REBYTE *Scan_Hex(REBYTE *cp, REBI64 *num, REBCNT minlen, REBCNT maxlen); // l-types.c
extern REBOOL Scan_Hex2(REBYTE *bp, REBUNI *n, REBFLG uni); // l-types.c
extern REBINT Scan_Hex_Bytes(REBVAL *val, REBCNT maxlen, REBYTE *out); // l-types.c
extern REBCNT Scan_Hex_Value(void *src, REBCNT len, REBOOL uni); // l-types.c
extern REBYTE *Scan_Dec_Buf(REBYTE *cp, REBCNT len, REBYTE *buf); // l-types.c
extern REBYTE *Scan_Decimal(REBYTE *cp, REBCNT len, REBVAL *value, REBFLG dec_only); // l-types.c
extern REBYTE *Scan_Integer(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_Money(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_Date(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_String(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_File(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_Email(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_URL(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_Pair(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_Tuple(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_Binary(REBYTE *cp, REBCNT len, REBVAL *value); // l-types.c
extern REBYTE *Scan_Any(REBYTE *cp, REBCNT len, REBVAL *value, REBYTE type); // l-types.c
extern REBSER *Load_Markup(REBYTE *cp, REBINT len); // l-types.c
...
extern void Append_Series(REBSER *series, REBYTE *data, REBCNT len); // m-series.c
extern void Append_Mem_Extra(REBSER *series, REBYTE *data, REBCNT len, REBCNT extra); // m-series.c
...
extern REBFLG Find_Gob_Tree(REBGOB *gob, REBGOB *tgob); // n-graphics.c
extern void Trap_Image(); // n-graphics.c
...
extern REBVAL *Append_Event(); // p-event.c
extern void Init_Event_Scheme(void); // p-event.c
extern void Ret_Query_File(REBSER *port, REBREQ *file, REBVAL *ret); // p-file.c
extern void Init_File_Scheme(void); // p-file.c
extern void Init_TCP_Scheme(void); // p-net.c
extern void Init_Timer_Scheme(void); // p-timer.c
extern void Init_Char_Cases(void); // s-cases.c
extern REBINT Compute_CRC(REBYTE *str, REBCNT len); // s-crc.c
extern REBINT Hash_String(REBYTE *str, REBCNT len); // s-crc.c
extern REBINT Hash_Word(REBYTE *str, REBINT len); // s-crc.c
...
extern REBSER *Value_To_OS_Path(REBVAL *val); // s-file.c
extern REBINT Compare_Binary_Vals(REBVAL *v1, REBVAL *v2); // s-find.c
extern REBINT Compare_Bytes(REBYTE *b1, REBYTE *b2, REBCNT len, REBOOL uncase); // s-find.c
extern REBYTE *Match_Bytes(REBYTE *src, REBYTE *pat); // s-find.c
...
extern REBINT Compare_UTF8(REBYTE *s1, REBYTE *s2, REBCNT l2); // s-find.c
...
extern REBSER *Copy_Bytes(REBYTE *src, REBINT len); // s-make.c
...
extern REBSER *Append_Bytes_Len(REBSER *dst, REBYTE *src, REBCNT len); // s-make.c
extern REBSER *Append_Bytes(REBSER *dst, REBYTE *src); // s-make.c
...
extern REBSER *Append_UTF8(REBSER *dst, REBYTE *src, REBINT len); // s-make.c
extern REBSER *Join_Binary(REBVAL *blk); // s-make.c
extern REBSER *Emit(REB_MOLD *mold, REBYTE *fmt, ...); // s-mold.c
...
extern REBCNT Deline_Bytes(REBYTE *buf, REBCNT len); // s-ops.c
extern REBCNT Deline_Uni(REBUNI *buf, REBCNT len); // s-ops.c
extern void Enline_Bytes(REBSER *ser, REBCNT idx, REBCNT len); // s-ops.c
extern void Enline_Uni(REBSER *ser, REBCNT idx, REBCNT len); // s-ops.c
...
extern REBINT What_UTF(REBYTE *bp, REBCNT len); // s-unicode.c
...
extern REBCNT Decode_UTF8_Char(REBYTE **str, REBINT *len); // s-unicode.c
extern int Decode_UTF8(REBUNI *dst, REBYTE *src, REBINT len, REBFLG ccr); // s-unicode.c
extern int Decode_UTF16(REBUNI *dst, REBYTE *src, REBINT len, REBFLG lee, REBFLG ccr); // s-unicode.c
extern int Decode_UTF32(REBUNI *dst, REBYTE *src, REBINT len, REBFLG lee, REBFLG ccr); // s-unicode.c
extern REBSER *Decode_UTF_String(REBYTE *bp, REBCNT len, REBINT utf); // s-unicode.c
...
extern REBSER *Encode_String(void *str, REBCNT len, REBCNT opts); // s-unicode.c
...
extern REBSER *GC_Event(REBVAL *value); // t-event.c
...
extern void RGB_To_Bin(REBYTE *bin, REBYTE *rgba, REBINT len, REBOOL alpha); // t-image.c
...
extern void Alpha_To_Bin(REBYTE *bin, REBYTE *rgba, REBINT len); // t-image.c
extern void Bin_To_Alpha(REBYTE *rgba, REBCNT size, REBYTE *bin, REBINT len); // t-image.c
...
extern void Image_To_BGRA(REBYTE *rgba, REBYTE *bin, REBINT len); // t-image.c
...
extern REBYTE *Scan_Time(REBYTE *cp, REBCNT len, REBVAL *value); // t-time.c
extern void Emit_Time(REB_MOLD *mold, REBVAL *value); // t-time.c
...
extern REBSER *Compress(REBSER *input, REBINT index, REBINT len, REBFLG use_crc); // u-compress.c
extern REBSER *Decompress(REBSER *input, REBCNT index, REBINT len, REBCNT limit, REBFLG use_crc); // u-compress.c
...
extern int Codec_JPEG_Image(REBCDI *codi); // u-jpg.c
...
extern REBYTE *SHA1(REBYTE *d, REBCNT n, REBYTE *md); // u-sha1.c
