...
#ifdef REB_64 // TOD 2013-09-25 long is actually i64/u64 in 64-bit mode
typedef int             i32;
...
#ifdef REB_64 // TOD 2013-09-25 should be explicit about size since we depend on it
  // but it only makes a difference in 64-bit mode
  i32 l;
  i32 h;
#else
	long l;
...
#ifndef MIN // TOD 2013-04-29 Added to prevent macro redefinition errors
#ifdef min
